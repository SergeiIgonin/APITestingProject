...
class GoogleMapsApi:
    ...
    def create_new_place():
        ...
        print(post_url)
        result_post = HttpMethods.post(post_url, json_for_create_new_place)  # отправка метода POST, в котором мы указываем url и body
        print(f'Response POST: {result_post.json()}')
        return result_post
    ...
    def get_new_place(place_id):
        ...
        print(f'Response GET: {result_get.json()}')
        return result_get
    ...
    def put_new_place(place_id):
        ...
        print(f'Response PUT: {result_put.json()}')
        return result_put
    ...
    def delete_new_place(place_id):
        ...
        print(f'Response DELETE: {result_delete.json()}')
